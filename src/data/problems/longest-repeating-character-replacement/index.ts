...
const longestRepeatingCharacterReplacement: PracticeProblem = {
  id: 'longest-repeating-character-replacement',
  title: 'Longest Repeating Character Replacement',
  difficulty: 'Medium',
  category: 'Strings',
  description:
    'Given a string and an integer `k`, return the length of the longest substring that can be converted into a string of one repeated character by replacing at most `k` characters.',
  examples: [
    {
      input: 's = "AABABBA", k = 1',
      output: '4',
