...
export const problem: PracticeProblem = {
  ...
  difficulty: `Easy`,
  category: `Binary`,
  description: `Given an array containing n distinct numbers from the range 0 through n, return the one number in that range that is missing from the array.`,
  examples: [
    {
      input: "nums = [3,0,1]",
      output: "2",
